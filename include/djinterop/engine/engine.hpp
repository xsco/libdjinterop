...
/// Engine DJ desktop 4.1.0
constexpr const engine_version desktop_4_1_0{
    semantic_version{4, 1, 0}, engine_database_type::desktop,
    "Engine DJ Desktop 4.1.0", semantic_version{3, 0, 0}};

/// Set of available versions.
constexpr const std::array<engine_version, 26> all_versions{
