...
INSERT INTO Information VALUES(1,'6103d7e0-8a13-4bdc-a947-3cef5784c93a',1,15,0,186590130847151828,0);
...
CREATE TABLE List ( [id] INTEGER, [type] INTEGER, [title] TEXT, [path] TEXT, [isFolder] NUMERIC, [trackCount] INTEGER, [ordering] INTEGER, [isExplicitlyExported] NUMERIC, PRIMARY KEY ( [id], [type] ) );
INSERT INTO List VALUES(1,2,'History 1','History 1;',0,1,1,0);
INSERT INTO List VALUES(2,3,'Prepare','Prepare;',0,0,1,0);
