...
INSERT INTO Information VALUES(1,'8930c87b-ed57-4138-b961-7eb6aea8f34c',1,18,0,123771454349570620,0);
...
CREATE TABLE List ( [id] INTEGER, [type] INTEGER, [title] TEXT, [path] TEXT, [isFolder] INTEGER, [trackCount] INTEGER, [ordering] INTEGER, [isExplicitlyExported] INTEGER DEFAULT 1, PRIMARY KEY ( [id], [type] ) );
...
INSERT INTO ListParentList VALUES(1,2,1,2);
INSERT INTO ListParentList VALUES(2,3,2,3);
...
CREATE TRIGGER trigger_insert_Crate INSTEAD OF INSERT ON Crate FOR EACH ROW BEGIN   INSERT INTO List ( id, type, title, path, isFolder, trackCount, ordering )    VALUES ( NEW.id, 4, NEW.title, NEW.path, 0, 0, NEW.id ) ; END;
