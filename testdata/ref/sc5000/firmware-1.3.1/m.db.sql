...
INSERT INTO Information VALUES(1,'4627a851-cf7b-401e-a967-5432a25753d9',1,13,2,7590900216473608163,0);
...
CREATE TABLE List ( [id] INTEGER, [type] INTEGER, [title] TEXT, [path] TEXT, [isFolder] NUMERIC, [trackCount] INTEGER, [ordering] INTEGER, PRIMARY KEY ( [id], [type] ) );
INSERT INTO List VALUES(1,2,'History 1','History 1;',0,1,1);
INSERT INTO List VALUES(2,3,'Prepare','Prepare;',0,0,1);
...
CREATE TABLE InternalDatabase ( [uuid] TEXT, [name] TEXT, PRIMARY KEY ( [uuid] ) );
...
CREATE INDEX index_InternalDatabase_uuid ON InternalDatabase ( uuid );
COMMIT;
