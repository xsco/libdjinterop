...
INSERT INTO Information VALUES(1,'330f40c4-5811-4693-b42d-e92f91613ee4',1,11,1,2184176255522968611,0);
...
CREATE TABLE List ( [id] INTEGER, [type] INTEGER, [title] TEXT, [path] TEXT, [isFolder] NUMERIC, [trackCount] INTEGER, PRIMARY KEY ( [id], [type] ) );
INSERT INTO List VALUES(1,2,'History 1','History 1;',0,2);
INSERT INTO List VALUES(2,3,'Prepare','Prepare;',0,0);
