...
inline void populate_track_snapshot(
    ...
    djinterop::semantic_version schema_version, djinterop::track_snapshot& s)
{
    switch (snapshot_type)
    {
        ...
        case example_track_type::fully_analysed_1:
        {
            ...
            if (schema_version >= djinterop::enginelibrary::version_1_15_0)
            {
            ...
            s.hot_cues[1] = djinterop::hot_cue{
                ...
                djinterop::enginelibrary::standard_pad_colors::pad_2};
            s.hot_cues[5] = djinterop::hot_cue{
                "Example other cue", 185375,
                djinterop::enginelibrary::standard_pad_colors::pad_6};
            ...
            s.loops[7] = djinterop::loop{
                ...
                djinterop::enginelibrary::standard_pad_colors::pad_8};
            ...
            int64_t samples_per_entry =
                djinterop::enginelibrary::required_waveform_samples_per_entry(
