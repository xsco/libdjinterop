...
BOOST_DATA_TEST_CASE(
    ctor__supported_version_copy__copies, e::all_v1_versions, version)
{
...
BOOST_DATA_TEST_CASE(
    op_copy_assign__supported_version_copy__copies, e::all_v1_versions, version)
{
    // Arrange
    BOOST_TEST_CHECKPOINT("(" << version << ") Creating temporary database...");
    auto db = e::create_temporary_database(version);
...
BOOST_DATA_TEST_CASE(
    ...
    e::all_v1_versions* creatable_snapshot_types, version, snapshot_type)
{
...
BOOST_DATA_TEST_CASE(
    ...
    e::all_v1_versions* updatable_snapshot_type_pairs, version,
    snapshot_type_pair)
{
    BOOST_TEST_CHECKPOINT(
...
BOOST_DATA_TEST_CASE(
    set_average_loudness__zero__no_loudness, e::all_v1_versions, version)
{
    // Arrange
    BOOST_TEST_CHECKPOINT("(" << version << ") Creating temporary database...");
    auto db = e::create_temporary_database(version);
...
BOOST_DATA_TEST_CASE(
    set_sampling__zero_rate__no_sampling, e::all_v1_versions, version)
{
    // Arrange
    BOOST_TEST_CHECKPOINT("(" << version << ") Creating temporary database...");
    auto db = e::create_temporary_database(version);
