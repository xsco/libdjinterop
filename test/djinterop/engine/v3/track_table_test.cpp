...
BOOST_DATA_TEST_CASE(
    add_with_existing_id_throws, e::supported_v3_schemas, schema)
{
    // Arrange
    auto library = ev3::engine_library::create_temporary(schema);
    ...
    // Act/Assert
    BOOST_CHECK_THROW(library.track().add(row), ev3::track_row_id_error);
}
    ...
    schema, row_type)
{
    ...
    auto id = library.track().add(expected);
    expected.id = id;
    ...
    auto actual = library.track().get(id);
    ...
    schema, initial_row_type, update_row_type)
{
    ...
    auto id = library.track().add(initial);
...
#define DEFINE_GETTER_VALID_TEST_CASE(engine_column, min_schema)        \
    ...
    {                                                                   \
        ...
        {                                                               \
            auto actual = library.track().get_##engine_column(id);        \
            BOOST_CHECK_EQUAL(                                          \
        ...
        {                                                               \
            BOOST_CHECK_THROW(                                          \
                library.track().get_##engine_column(id),                  \
...
#define DEFINE_SETTER_VALID_TEST_CASE(engine_column, min_schema)            \
    ...
    {                                                                       \
        ...
        if (schema >= min_schema)                                           \
        {                                                                   \
            library.track().set_##engine_column(id, expected);                \
                                                                            \
            auto actual = library.track().get_##engine_column(id);            \
            BOOST_CHECK_EQUAL(                                              \
                make_printable(expected), make_printable(actual));          \
...
#define DEFINE_GETTER_INVALID_TEST_CASE(engine_column, min_schema)        \
    ...
    {                                                                     \
        ...
        {                                                                 \
            BOOST_CHECK_THROW(                                            \
                library.track().get_##engine_column(12345),                 \
...
#define DEFINE_SETTER_INVALID_TEST_CASE(engine_column, min_schema)           \
    ...
    {                                                                        \
        ...
        {                                                                    \
            BOOST_CHECK_THROW(                                               \
                library.track().set_##engine_column(12345, row.engine_column), \
                ev3::track_row_id_error);                                    \
        }                                                                    \
        else                                                                 \
        {                                                                    \
...
DEFINE_GETTER_SETTER_TEST_CASES(play_order, es::schema_3_1_0)
DEFINE_GETTER_SETTER_TEST_CASES(length, es::schema_3_1_0)
DEFINE_GETTER_SETTER_TEST_CASES(bpm, es::schema_3_1_0)
DEFINE_GETTER_SETTER_TEST_CASES(year, es::schema_3_1_0)
DEFINE_GETTER_SETTER_TEST_CASES(path, es::schema_3_1_0)
DEFINE_GETTER_SETTER_TEST_CASES(filename, es::schema_3_1_0)
DEFINE_GETTER_SETTER_TEST_CASES(bitrate, es::schema_3_1_0)
DEFINE_GETTER_SETTER_TEST_CASES(bpm_analyzed, es::schema_3_1_0)
DEFINE_GETTER_SETTER_TEST_CASES(album_art_id, es::schema_3_1_0)
DEFINE_GETTER_SETTER_TEST_CASES(file_bytes, es::schema_3_1_0)
DEFINE_GETTER_SETTER_TEST_CASES(title, es::schema_3_1_0)
DEFINE_GETTER_SETTER_TEST_CASES(artist, es::schema_3_1_0)
DEFINE_GETTER_SETTER_TEST_CASES(album, es::schema_3_1_0)
DEFINE_GETTER_SETTER_TEST_CASES(genre, es::schema_3_1_0)
DEFINE_GETTER_SETTER_TEST_CASES(comment, es::schema_3_1_0)
DEFINE_GETTER_SETTER_TEST_CASES(label, es::schema_3_1_0)
DEFINE_GETTER_SETTER_TEST_CASES(composer, es::schema_3_1_0)
DEFINE_GETTER_SETTER_TEST_CASES(remixer, es::schema_3_1_0)
DEFINE_GETTER_SETTER_TEST_CASES(key, es::schema_3_1_0)
DEFINE_GETTER_SETTER_TEST_CASES(rating, es::schema_3_1_0)
DEFINE_GETTER_SETTER_TEST_CASES(album_art, es::schema_3_1_0)
DEFINE_GETTER_SETTER_TEST_CASES(time_last_played, es::schema_3_1_0)
DEFINE_GETTER_SETTER_TEST_CASES(is_played, es::schema_3_1_0)
DEFINE_GETTER_SETTER_TEST_CASES(file_type, es::schema_3_1_0)
DEFINE_GETTER_SETTER_TEST_CASES(is_analyzed, es::schema_3_1_0)
DEFINE_GETTER_SETTER_TEST_CASES(date_created, es::schema_3_1_0)
DEFINE_GETTER_SETTER_TEST_CASES(date_added, es::schema_3_1_0)
DEFINE_GETTER_SETTER_TEST_CASES(is_available, es::schema_3_1_0)
DEFINE_GETTER_SETTER_TEST_CASES(
    is_metadata_of_packed_track_changed, es::schema_3_1_0)
DEFINE_GETTER_SETTER_TEST_CASES(
    is_performance_data_of_packed_track_changed, es::schema_3_1_0)
DEFINE_GETTER_SETTER_TEST_CASES(played_indicator, es::schema_3_1_0)
DEFINE_GETTER_SETTER_TEST_CASES(is_metadata_imported, es::schema_3_1_0)
DEFINE_GETTER_SETTER_TEST_CASES(pdb_import_key, es::schema_3_1_0)
DEFINE_GETTER_SETTER_TEST_CASES(streaming_source, es::schema_3_1_0)
DEFINE_GETTER_SETTER_TEST_CASES(uri, es::schema_3_1_0)
DEFINE_GETTER_SETTER_TEST_CASES(is_beat_grid_locked, es::schema_3_1_0)
DEFINE_GETTER_SETTER_TEST_CASES(origin_database_uuid, es::schema_3_1_0)
DEFINE_GETTER_SETTER_TEST_CASES(origin_track_id, es::schema_3_1_0)
DEFINE_GETTER_SETTER_TEST_CASES(streaming_flags, es::schema_3_1_0)
DEFINE_GETTER_SETTER_TEST_CASES(explicit_lyrics, es::schema_3_1_0)
DEFINE_GETTER_SETTER_TEST_CASES(last_edit_time, es::schema_3_1_0)
