...
inline void validate(table_info::const_iterator iter, table_info::const_iterator end,
...
inline void validate(index_list::const_iterator iter, index_list::const_iterator end,
...
inline void validate(index_info::const_iterator iter, index_info::const_iterator end,
