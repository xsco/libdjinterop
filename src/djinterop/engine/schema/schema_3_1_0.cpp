...
{
void schema_3_1_0::verify_master_list(sqlite::database& db) const
{
...
void schema_3_1_0::verify_performance_data(sqlite::database& db) const
{
    {
...
void schema_3_1_0::verify_track(sqlite::database& db) const
{
...
void schema_3_1_0::verify(sqlite::database& db) const
{
