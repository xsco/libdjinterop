...
{
void schema_1_18_0_os::verify_list(sqlite::database& db) const
{
    {
...
void schema_1_18_0_os::verify_track(sqlite::database& db) const
{
    {
...
void schema_1_18_0_os::verify_performance_data(sqlite::database& db) const
{
    {
...
void schema_1_18_0_os::verify_music_schema(sqlite::database& db) const
{
...
void schema_1_18_0_os::verify_performance_schema(sqlite::database& db) const
{
    // List of tables unchanged since 1.17.0.
...
void schema_1_18_0_os::create_music_schema(sqlite::database& db)
{
...
void schema_1_18_0_os::create_performance_schema(sqlite::database& db)
{
