...
{
void schema_3_0_0::verify_master_list(sqlite::database& db) const
{
    // Schema 3.0.0 reinstates `PerformanceData` as a separate table.
    {
        ...
        ++iter;
        validate(iter, end, "table", "PerformanceData", "PerformanceData");
        ++iter;
...
void schema_3_0_0::verify_performance_data(sqlite::database& db) const
{
    {
...
void schema_3_0_0::verify_track(sqlite::database& db) const
{
    // Schema 3.0.0 moves some columns from Track to PerformanceData.
    {
...
void schema_3_0_0::verify(sqlite::database& db) const
{
...
void schema_3_0_0::create(sqlite::database& db)
{
